...
class BraveHeadlessIframeChecker:
    ...
    def setup_brave_driver(self):
        ...
        try:
            ...
            if not brave_found:
                print("❌ Bravs3e browser not found in standard locations")
                print("💡 Please install Brave browser or check installation path")
                return False
            ...
            if WEBDRIVER_MANAGER_AVAILABLE:
                print("📱 Getting ChromeDriver compatible with Brave 138...")
                try:
                    # For Brave 138, we need ChromeDriver 138
                    service = Service(ChromeDriverManager(driver_version="138.0.6051.0").install())
                    print("✅ Downloaded ChromeDriver 138")
                except Exception as v138_error:
                    print(f"⚠️  ChromeDriver 138 failed: {v138_error}")
                    try:
                        # Try the latest stable version
                        from webdriver_manager.chrome import ChromeDriverManager
                        from webdriver_manager.core.utils import ChromeType
                        service = Service(ChromeDriverManager(chrome_type=ChromeType.CHROMIUM).install())
                        print("✅ Downloaded Chromium-compatible driver")
                    except Exception as chromium_error:
                        print(f"⚠️  Chromium driver failed: {chromium_error}")
                        service = None
            ...
            if service is None:
                ...
                try:
                    ...
                    print("💡 Please update ChromeDriver manually:")
    ...
    def check_page_iframes_with_brave(self, page_url):
        ...
        try:
            print(f"    🌐 Loading page with Brave (headless)...")
    ...
    def crawl_blog_pages(self):
        ...
        print("Strategy: HTTP check first, Brave headless only for pages with iframes")
        print("=" * 60)
        ...
        for i, page_url in enumerate(self.blog_urls, 1):
            ...
            print(f"    🎯 Found main-wrapper(s) with iframe(s) - using Brave headless to check content")
    ...
    def run(self):
        ...
        print("Brave Background Iframe Checker")
